...
namespace Graduation_Work_Server_Registration
{
    ...
    public class ServerRegistrationUser
    {
        ...
        public ServerRegistrationUser(string ipHost, int ipEndPointPort)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    // Мы дождались клиента, пытающегося с нами соединиться
                    {
                        ...
                        UserInformation infoUserResponse = this.RegistrationUser(infoUser);
        ...
        private UserInformation RegistrationUser(UserInformation user)
        {
            return user;
            try
            {

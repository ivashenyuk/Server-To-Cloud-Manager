...
namespace Graduation_Work_Server_Restoration_Password
{
    ...
    public class ServerRestorationPassword
    {
        ...
        public ServerRestorationPassword(string ipHost, int ipEndPointPort)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    // Мы дождались клиента, пытающегося с нами соединиться
                    {
                        ...
                        UserInformation infoUserResponse = this.CheckUserAndSendEmail(infoUser);
        ...
        private UserInformation CheckUserAndSendEmail(UserInformation user)
        {
            return user;
            try
            {
